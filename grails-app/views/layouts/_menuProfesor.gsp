            ...
            <nav class="navbar">
                ...
                <div class="nav-collapse collapse">
                    <ul class="nav nav-pills ddmenu">
                        ...
                        <li class="dropdown">
                            <a href="${createLink(controller: 'profesor',action:'solicitudes')}" class="dropdown-toggle">Solicitudes Pendientes<b ></b></a>
                        </li>
                        <li class="dropdown">
                            <a href="${createLink(controller: 'profesor',action:'calificar')}" class="dropdown-toggle">Calificar Alumno <b ></b></a>
                        </li>
                    </ul>
                </div>
            </nav>
