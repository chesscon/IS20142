	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="createProfesor"><g:message code="Lista de profesores a ser aceptados" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="show-profesor" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:profesorInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="aceptar" resource="${profesorInstance}"><g:message code="Aceptar Profesor" default="Aceptar Profesor" /></g:link>
